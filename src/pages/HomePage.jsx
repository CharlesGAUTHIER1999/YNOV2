...
import Footer from '../component/footer/Footer'; // Assurez-vous d'importer le Footer correctement
import './HomePage.css'; // Assurez-vous d'avoir un fichier CSS pour styliser la page

function HomePage() {
  const navigate = useNavigate();

  // Fonction de redirection vers la page des résultats avec des filtres
  ...
  return (
    <div className="homepage">
      <NavBar />
      {/* Section principale avec blocs de présentation */}
