...
// Correction de l'icône par défaut pour les marqueurs Leaflet
...
const MapComponent = ({ latitude = 46.603354, longitude = 1.888334, city = 'France', zoomLevel = 6 }) => {
  ...
  useEffect(() => {
    // Si la carte est déjà initialisée, on recentre et on zoome
    if (mapRef.current) {
      const mapInstance = mapRef.current;
      mapInstance.setView([latitude, longitude], zoomLevel); // Mettre à jour la vue
    }
